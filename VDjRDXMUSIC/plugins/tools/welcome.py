...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("VDjRDXMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('VDjRDXMUSIC/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('VDjRDXMUSIC/assets/font.ttf', size=60)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "VDjRDXMUSIC/assets/upic.png"
